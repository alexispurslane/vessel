...
/** Item type for PillList and PillKeyValueList – has an optional editing flag and arbitrary string-keyed values */
export interface PillItem {
    editing?: boolean;
    [key: string]: unknown;
}

/** Alias for PillItem, used by PillKeyValueList */
export type KeyValueItem = PillItem;
